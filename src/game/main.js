    ...
    .body(function () {
        game.createScene('Main', {
            init: function () {
                ...
                this.road_tile = new game.TilingSprite(
                    'assets/asphalt.jpg',
                    game.width,
                    100
                )
                this.mountain_tile = new game.TilingSprite(
                    'assets/mountain1.png',
                    game.width,
                    game.height
                )
                this.mountain_tile2 = new game.TilingSprite(
                ...
                this.roadside_tile = new game.TilingSprite(
                    'assets/roadside.png',
                    game.width * 2,
                    200
                )
                ...
                this.mps_body_iso = new game.Sprite(
                    'Mazda3MPS__mainframe-iso.png'
                )
            ...
            update: function () {
                this.mountain_tile.tilePosition.x +=
                    this.moving_speed * 0.97 * game.delta
                this.mountain_tile2.tilePosition.x +=
                    this.moving_speed * 0.95 * game.delta
                this.sky_bg.tilePosition.x +=
                    this.moving_speed * 0.7 * game.delta
                this.roadside_tile.tilePosition.x +=
                    this.moving_speed * 20 * game.delta
                this.road_tile.tilePosition.x +=
                    this.moving_speed * 10 * game.delta
